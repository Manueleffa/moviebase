    ...
    <>
      <div className="bg-[#020d18] text-white h-screen grid grid-cols-4">
        <aside className="col-span-1 m-4 px-3 py-3 border border-[#3a414e] rounded-xl relative">
          <div className="mb-6">
            <div className="flex items-center">
              ...
              <h1 className="text-2xl font-bold text-yellow-700">MBase</h1>
            </div>
          </div>
        ...
        <main className="col-span-3 border my-4 mr-4 rounded-xl border-[#3a414e] px-3 py-3">
          ...
          <div>
            <h2 className="text-3xl font-bold mb-7 text-center mt-10">Popular Movies</h2>
            <div className="grid grid-cols-4 gap-4">
              <div className=" bg-yellow-700 border border-yellow-700 rounded overflow-x-hidden">
                ...
                <div>
                  ...
                  <p className="text-[14px] px-2 font-semibold mb-4">Realease Date: xxxx/xx/xx</p>
                </div>
              </div>
